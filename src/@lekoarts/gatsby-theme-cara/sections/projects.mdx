...
<ProjectCard title="FlipCard Quiz App" link="https://quiz-game-by-shakeel.netlify.app/" bg="linear-gradient(to right, rgb(2, 200, 176), rgb(0, 205, 172))">
This project was built using ReactJS where you can generate random quiz questions by selecting a category and amount of questions.
</ProjectCard>
